...
> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="fixed top-0 left-0 inset-0 flex flex-col items-center justify-center p-8 lg:p-12 text-center bg-white z-50 animate-in fade-in duration-700">
