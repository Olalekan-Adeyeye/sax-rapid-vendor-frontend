...
import { UserCog, Bell, Shield, Lock, Save, ChevronRight, Loader2 } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-12">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        ...
        <button 
          ...
          className="px-8 py-4 rounded bg-gold text-[10px] font-black uppercase tracking-widest text-black hover:bg-black hover:text-white transition-all flex items-center justify-center gap-3 disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
        <div className="lg:col-span-1 space-y-8">
          <div className="bg-white border border-gray-100 rounded p-8 flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h4 className="text-sm font-black uppercase tracking-tight text-black">
                {user?.firstName && user?.lastName ? `${user.firstName} ${user.lastName}` : "TechWorld Enterprise"}
              </h4>
          ...
          <div className="bg-black text-white rounded p-8 space-y-6">
            <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-gold">
              Security Score
            </h5>
            <div className="flex items-end gap-2">
              <span className="text-3xl font-black tracking-tighter">92%</span>
              <span className="text-[8px] font-black uppercase tracking-widest text-green-500 mb-1.5">
                Elite Level
              </span>
            </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-6 rounded bg-gray-50 group hover:border-gold border border-transparent transition-all cursor-pointer">
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-[8px] font-black uppercase tracking-widest text-green-500 bg-green-50 px-3 py-1.5 rounded-full">
                        ENABLED
                      </span>
                ...
                {[
                  ...
                  >
                    <div className="max-w-md">
                      <h5 className="text-[11px] font-black uppercase tracking-tight text-black mb-1">
                        {notif.label}
                      </h5>
