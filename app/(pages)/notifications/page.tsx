											...
											<div className="flex items-start gap-6">
												...
												<div className="flex-1 min-w-0">
													<div className="flex items-center justify-between mb-2">
														<h5
															className={`text-sm tracking-tight transition-colors ${!item.isRead ? "font-black text-black" : "font-bold text-gray-600"}`}
														>
															{item.title}
														</h5>
													...
													<p
														className={`text-xs leading-relaxed ${!item.isRead ? "text-gray-900 font-bold" : "text-gray-500 font-medium"}`}
													>
														{item.message}
													</p>
												</div>
