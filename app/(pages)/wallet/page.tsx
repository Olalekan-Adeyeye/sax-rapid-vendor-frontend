				...
				<div className="lg:col-span-8 space-y-8">
					<div className="bg-white border border-gray-100 rounded overflow-hidden shadow-sm hover:shadow-none transition-shadow">
						...
						<div className="divide-y divide-gray-50">
							{[
								{
									title: "Payout to GTBank Account",
									type: "Withdrawal",
									amount: "₦450,000",
									status: "Completed",
									date: "Today, 10:45 AM",
								...
								{
									title: "Sale: Premium Watch 5 #8291",
									type: "Earnings",
									amount: "₦125,000",
									status: "Completed",
									date: "Mar 16, 2026",
								...
								>
									<div className="flex items-center gap-6">
										<div
											className={`w-12 h-12 rounded bg-gray-50 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-all ${t.sign === "+" ? "text-green-500" : "text-red-500"}`}
										>
											<t.icon size={20} />
										</div>
										<div>
									...
									<div className="text-right">
										<p
											className={`text-sm font-black mb-1 ${t.sign === "+" ? "text-green-500" : "text-black"}`}
										>
											{t.sign}
											{t.amount}
										</p>
										<span className="text-[8px] font-black uppercase tracking-widest text-gray-300">
											Transaction ID: TXN-4921-X
										</span>
									</div>
								</div>
							))}
