		...
		<div className="max-w-4xl mx-auto space-y-12">
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-6">
					<Link href="/products" className="w-10 h-10 rounded border border-gray-100 flex items-center justify-center text-gray-400 hover:text-black hover:bg-gray-50 transition-all">
						<ArrowLeft size={16} />
					</Link>
					<div>
				...
				<div className="flex gap-3">
					<button className="px-8 py-3.5 rounded border border-gray-100 text-[10px] font-black uppercase tracking-widest text-black hover:bg-gray-50 transition-all">
						Save Draft
					</button>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
				<div className="lg:col-span-2 space-y-10">
					...
					<div className="bg-white border border-gray-100 rounded p-8 space-y-8">
						<h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-gold pb-6 border-b border-gray-50">General Information</h4>
						<div className="space-y-6">
							...
							<div className="space-y-2.5">
								<label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Product Description</label>
								<textarea 
									rows={6}
					...
					{/* Media */}
					<div className="bg-white border border-gray-100 rounded p-8 space-y-8">
						<h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-gold pb-6 border-b border-gray-50">Product Gallery</h4>
						<div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
							<div className="aspect-square border-2 border-dashed border-gray-100 rounded-lg flex flex-col items-center justify-center text-gray-400 hover:border-gold hover:text-gold transition-all cursor-pointer group">
								...
								<span className="text-[8px] font-black uppercase tracking-widest">Main Product</span>
							</div>
							{[1, 2, 3].map((i) => (
								<div key={i} className="aspect-square border-2 border-dashed border-gray-100 rounded-lg flex flex-col items-center justify-center text-gray-200 hover:border-gold hover:text-gold transition-all cursor-pointer group">
									<Plus size={20} />
								</div>
							))}
						</div>
						<p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed">
							Max 4 images. Files must be less than 2MB. Recommended size: 1000x1000px.
						</p>
					</div>
				</div>
				...
				<div className="space-y-10">
					{/* Pricing & Logic */}
					<div className="bg-white border border-gray-100 rounded p-8 space-y-8">
						<h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-gold pb-6 border-b border-gray-50">Inventory & Pricing</h4>
						<div className="space-y-6">
							<div className="space-y-2.5">
							...
							<div className="space-y-2.5">
								<label className="text-[10px] font-black uppercase tracking-widest text-gray-400">SKU Number</label>
								<input 
									type="text" 
					...
					{/* Category */}
					<div className="bg-white border border-gray-100 rounded p-8 space-y-8">
						<h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-gold pb-6 border-b border-gray-50">Organization</h4>
						<div className="space-y-6">
							<div className="space-y-2.5">
							...
							<div className="space-y-2.5">
								<label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Launch Status</label>
								<div className="flex gap-2">
									<button className="flex-1 py-3.5 rounded bg-black text-[9px] font-black uppercase tracking-widest text-white border border-black transition-all">Publish</button>
									<button className="flex-1 py-3.5 rounded bg-white text-[9px] font-black uppercase tracking-widest text-gray-400 border border-gray-100 hover:border-gold transition-all">Schedule</button>
								</div>
							</div>
						</div>
					</div>
