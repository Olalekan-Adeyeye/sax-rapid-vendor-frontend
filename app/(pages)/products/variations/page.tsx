					...
					<table className="w-full text-left min-w-250">
						...
						<tbody className="divide-y divide-gray-50">
							{[
								...
								{
									parent: "Hair Extension",
									details: 'Length: 22" · Color: Honey Blonde',
									sku: "HAIR-381-22-HB",
									price: "₦85,000",
									stock: 15,
									status: "Active",
								...
								{
									parent: "Hair Extension",
									details: 'Length: 18" · Color: Natural Black',
									sku: "HAIR-381-18-NB",
									price: "₦65,000",
									stock: 32,
									status: "Active",
								...
								>
									...
									<td className="px-8 py-5">
										<span
											className={`text-[8px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full ${v.status === "Active" ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}
										>
											{v.status}
										</span>
									</td>
