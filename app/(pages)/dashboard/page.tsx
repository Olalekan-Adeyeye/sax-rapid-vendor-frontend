...
function ProductViewCard({
	...
	return (
		<div className="bg-white border border-gray-100 rounded overflow-hidden group hover:border-gold/30 transition-all">
			...
			<div className="p-4">
				<p className="text-[9px] font-black uppercase tracking-widest text-gray-400 mb-1">Product View</p>
				<h4 className="text-xs font-black text-black tracking-tight mb-2 truncate">{name}</h4>
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-1.5">
						<Eye size={12} className="text-gold" />
						<span className="text-xs font-black text-black">{views}</span>
					</div>
					<span className="text-[9px] font-black text-green-600">+{change}%</span>
				</div>
			</div>
		</div>
	);
		...
		<div className="space-y-10 lg:space-y-14">
			...
			<div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 min-w-0">
				<div className="min-w-0">
					<h2 className="text-2xl lg:text-4xl font-black tracking-tighter text-black truncate sm:whitespace-normal uppercase">
						Vendor performance
					</h2>
				...
				<div className="space-y-6">
					...
					<div className="bg-white border border-gray-100 rounded divide-y divide-gray-50">
						{[
							...
							<div key={i} className="p-5 hover:bg-gray-50/50 transition-colors group cursor-pointer relative overflow-hidden">
								<div className="flex items-start gap-4">
									...
									<div className="flex-1 min-w-0">
										<div className="flex items-center justify-between mb-1">
											<h5 className="text-[11px] font-black uppercase tracking-tight text-black truncate">{item.title}</h5>
											<span className="text-[8px] font-bold text-gray-400 uppercase">{item.time}</span>
										</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
				<div className="bg-white border border-gray-100 rounded p-6 lg:p-8">
					<div className="flex items-center justify-between mb-8">
						<h4 className="text-[10px] font-black uppercase tracking-widest text-black">Revenue Performance</h4>
					...
					<div className="h-48 flex items-end gap-3 px-4">
						{[40, 65, 45, 80, 55, 95, 70, 85, 60, 100, 75, 90].map((h, i) => (
							<div key={i} className="flex-1 bg-gray-50 rounded-t relative group">
								<div 
				...
				<div className="bg-white border border-gray-100 rounded p-6 lg:p-8">
					<div className="flex items-center justify-between mb-8">
						<h4 className="text-[10px] font-black uppercase tracking-widest text-black">Popular Categories</h4>
