											...
											>
												<td className="px-8 py-6">
													<div className="flex items-center gap-4">
														...
														<div>
															<p className="text-sm font-black text-black group-hover:text-gold transition-colors truncate max-w-[150px]">
																{product.productName}
															</p>
												...
												<td className="px-8 py-6">
													<div className="flex items-center gap-3">
														<div className="flex-1 max-w-[60px] h-1.5 bg-gray-50 rounded-full overflow-hidden">
															<div
								...
								<div key={order.id} className="flex gap-4 group">
									...
									<div className="flex-1 min-w-0">
										...
										<p className="text-[10px] font-bold text-gray-400 flex items-center gap-2">
											<span className={order.status === "Pending" ? "text-amber-500" : "text-green-500"}>
												{order.status}
											</span>
											<span>•</span>
						...
						<div className="space-y-6">
							...
							<div className="space-y-4">
								<div className="flex justify-between items-end">
									...
									<span className="text-[10px] font-black text-gold">Optimal</span>
								</div>
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-[9px] font-bold text-gray-400 uppercase">
										{loadingProductStats ? "..." : (productStats?.totalViews || 0).toLocaleString()} Total Views
									</p>
								</div>
							</div>
							<div className="flex items-start gap-4">
