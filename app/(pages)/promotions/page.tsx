...
import { Plus, Search, Tag, Rocket, Star } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {[
          ...
          >
            <div className="mb-10">
              <div
                className={`w-14 h-14 rounded flex items-center justify-center mb-6 group-hover:scale-110 transition-transform ${promo.color === "bg-black text-white" ? "bg-white/10 text-gold" : "bg-gold/20 text-gold"}`}
              >
                <promo.icon size={24} />
              </div>
        ...
        <div className="p-8 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Input
              ...
              className="py-2.5 text-[10px] font-black uppercase tracking-widest placeholder:text-gray-300"
              outerClassName="min-w-[240px]"
            />
          </div>
        </div>
