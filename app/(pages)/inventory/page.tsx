    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-gray-100 rounded p-6 lg:p-8 hover:border-gold/20 transition-all group">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-4 group-hover:text-gold transition-colors">
        ...
        <div className="bg-white border border-gray-100 rounded p-6 lg:p-8 hover:border-red-500/20 transition-all group">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-4 group-hover:text-red-500 transition-colors">
            Low Stock Alerts
          </p>
        ...
        <div className="bg-white border border-gray-100 rounded p-6 lg:p-8 hover:border-gray-500/20 transition-all group">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-4 group-hover:text-black transition-colors">
            Out of Stock
          </p>
