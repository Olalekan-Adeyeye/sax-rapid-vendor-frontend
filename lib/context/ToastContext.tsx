          ...
          {toasts.map((t) => (
            ...
            >
              <div className="group relative overflow-hidden bg-white/80 backdrop-blur-xl border border-gray-100 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-4 sm:p-5 flex items-start gap-3 sm:gap-4">
                ...
                >
                  {t.type === "success" && <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" />}
                  {t.type === "error" && <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5" />}
                  {t.type === "warning" && <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5" />}
                  {t.type === "info" && <Info className="w-4 h-4 sm:w-5 sm:h-5" />}
                </div>
